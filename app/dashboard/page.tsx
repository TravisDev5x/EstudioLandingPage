...
import { Pencil, Trash2, RotateCcw, Search, LogOut, X } from "lucide-react";
...
export default function DashboardPage() {
  ...
  return (
    <>
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-30 bg-[#0a0e1a]/80 backdrop-blur border-b border-white/[0.08] px-6 h-12 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Avatar size="sm" className="bg-indigo-500/30">
            <AvatarFallback className="text-indigo-300 text-[11px] bg-transparent">{sessionInitials}</AvatarFallback>
          </Avatar>
          <Button
            size="icon-sm"
            variant="ghost"
      ...
      <main className="min-h-screen bg-[#0a0e1a] flex items-center justify-center p-8 pt-20">
        ...
        {/* Card principal */}
        <Card className="w-full max-w-md relative z-10 py-0 gap-0 ring-0 border-white/10 bg-white/5 shadow-none">
